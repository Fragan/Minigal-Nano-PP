<?php
    ...
    */
    ...
    $thumbs_pr_page 		= "150"; //Number of thumbnails on a single page
    ...
    $label_max_length 		= 60; //Maximum chars of a folder name that will be displayed on the folder thumbnail  
