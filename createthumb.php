 ...
 * 
 * WORKAROUND
 * to prevent somme errors like
 * => Resource interpreted as Image but transferred with MIME type text/html: "http://localhost/mgn/createthumb.php?filename=photos/folder1/IMG_25.jpg&size=320".
 * due to
 * =>  Parse error: imagecreatefromjpeg(): gd-jpeg, libjpeg: recoverable error:  in Minigal-Nano-PP/createthumb.php on line 138
 */
