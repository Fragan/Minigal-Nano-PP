    ...
    <head>
        ...
        <meta name="robots" content="noindex, nofollow">
            ...
            <body>
                ...
                <div class="<?php if (version_compare(phpversion(), "4.0", '>')) echo 'middle-yes';
else echo 'middle-no' ?>">
<?php echo phpversion(); ?>
                </div>
                <div class="right">
                ...
                <div class="<?php if ($gd == "Yes") echo 'middle-yes';
else echo 'middle-no' ?>">
<?php echo $gd; ?>
                </div>
                <div class="right">
                ...
                <div  class="<?php if ($exif == "Yes") echo 'middle-yes';
else echo 'middle-neutral' ?>">
<?php echo $exif; ?>
                </div>
                <div class="right">
